...
[CompressionWebpackPlugin](https://webpack.js.org/plugins/compression-webpack-plugin/), [VitePluginCompression](https://github.com/nonzzz/vite-plugin-compression) 등의 플러그인을 사용하여 빌드 시 에셋 파일들을 gzip으로 압축할 수 있다.
