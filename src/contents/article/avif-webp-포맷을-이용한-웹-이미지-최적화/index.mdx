...
최근 [디그디그딥 프로젝트](https://github.com/prgrms-fe-devcourse/FEDC3_DigDigDeep_Yuri)의 Lighthouse Performance를 100점으로 개선했다. 이 블로그는 많은 기능을 포함하고 있지 않으니 당연히 100점이 나올거라 예상했지만 95점이 나왔다.

![개선 전 Lighthouse Performance 95점](lighthouse-before.png)
...
![이미지 페이로드가 909KB에서 21.4KB로 감소한 결과](image-payload-reduction.png)
...
![Lighthouse Performance 100점 달성 결과](lighthouse-after.png)
